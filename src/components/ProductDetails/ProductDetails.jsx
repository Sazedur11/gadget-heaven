    ...
    <div>
      ...
      <div className="md:flex gap-4 justify-center lg:w-3/6 md:w-5/6 mx-auto p-4 rounded-xl bg-base-300 -mt-30">
        ...
        <div>
          ...
          <p className="border-1 border-green-400 w-30 h-8 flex items-center justify-center text-green-500 bg-green-400/5 p-2 rounded-full">
            {availability}
          </p>
          ...
          <div className="flex gap-4 items-center mt-4">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-themecolor py-2 px-3 rounded-full text-white"
            >
              Add To Card <FiShoppingCart></FiShoppingCart>
            </button>
            <button
              onClick={() => handleAddToWishlist(pId)}
              className="bg-white text-black text-2xl rounded-full p-2"
            >
              {" "}
              <FiHeart></FiHeart>{" "}
            </button>
